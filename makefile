...
$(SERVER_EXECUTABLE): $(SERVER_SOURCES) $(AUTH_SOURCES) $(DBCONN_SOURCES) $(LIBRARY_FILE) $(ROOM_SOURCES)
	$(CC) $(CFLAGS) $(SERVER_SOURCES) $(AUTH_SOURCES) $(DBCONN_SOURCES) -o $(SERVER_EXECUTABLE) $(ROOM_SOURCES) $(LDFLAGS) 
